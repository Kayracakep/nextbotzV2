 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".botinfo", description: "✧ Info nya Hiraiwa Botz ><"},
	...
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 Hiraiwa Botz..."},
	]
    },{
...
const listMessage = {
  text: tek,
  footer: '© HotaruModz | ALL RESERVED',
